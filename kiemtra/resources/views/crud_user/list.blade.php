...
<body>
    <header>
        <nav><a href="index">Home</a> | <a href="login">Đăng xuất</a></nav>
    </header>
    <main style="display: block; width: 80%; margin: 20px auto;">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>1</td><td>UPVH</td><td>ATJW@gmail.com</td>
                    <td><a href="update">Edit</a> | <a href="view">View</a> | <a href="#">Delete</a></td>
                </tr>
                </tbody>
        </table>
